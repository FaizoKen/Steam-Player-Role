...
//! nav) and iframe-Bearer auth (RoleLogic dashboard iframe).
...
/// Outcome of a guild-scoped dual-gate check: who is calling and whether the
/// session is read-only (a developer impersonating the user).
